...
<body >
    ...
    PreparedStatement ps=con.prepareStatement("select sum(total_amt) from money where money_d_license=?");
    ps.setString(1,p1);
    ...
    while(rs.next())
    {
				 ...
				 %>
				<center>
				<h2 style="color:rgb(163,64,56);">Your total money received is:</h2>
				<br/>
				<input type="text" name="show" value="<%=rs.getString("sum(total_amt)") %>"/>
