...
<body>
  ...
  <%
    ...
    PreparedStatement ps1=con.prepareStatement("update ration_card_table set Status=? where Rationcard_no=?");
    ...
    <br/><br/><br/>
    <center><h2>This beneficiary has been registered successfully</h2>
