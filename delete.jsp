			...
			<div class="shell">
				...
				<nav id="navigation">
					...
					<br />
							...
							%>
							<center>
							<form action="deleteconnect.jsp">
							<table>	
						<th>Do you want to delete this beneficiary whose:</th>
						<tr><td>Ration Card Number</td><td><input type="text" readonly="readonly" name="rc" value="<%=r %>"/></td></tr>
						...
						<br/>		
						<form action="admin_beneficiary.jsp"><input type="submit" value="Cancel" style="font-size:20px;"/></form>
