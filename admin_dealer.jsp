...
<body>
	...
	<div id="wrapper">
		...
		<div class="shell">
			...
			<div class="container">
				...
				<br/><br/><br/>
				<center><h3 style="font-size:30px;"><font color="#800000" ><u><b>Dealers</b></u></font></h3></center>
      ...
      PreparedStatement ps=con.prepareStatement("select d.Firstname,d.Middlename,d.Lastname,d.License_no from dealer_status_table d where d.status='Active'");
    ...
    <tr>
      ...
      <td><a href="dealer_details.jsp?rcn=<%=rs.getString("License_no")%>&n=<%=rs.getString("Firstname")%>&n=<%=rs.getString("Middlename")%>&n=<%=rs.getString("Lastname")%>"><img src="css/images/view.png" width="18px" alt="View" title="View"/></a></td>
      
      <td><a href="dealer_delete.jsp?rcn=<%=rs.getString("License_no")%>&n=<%=rs.getString("Firstname")%>&n=<%=rs.getString("Middlename")%>&n=<%=rs.getString("Lastname")%>"><img src="css/images/delete.png" width="18px" alt="Delete" title="Delete"/></a></td>
    </tr>
    <%
    }
				 %>
		...
		con.close();		 %>
				...
				<form action="supply.jsp" method="post">
